...
import com.sensetime.intellij.plugins.sensecode.topics.SENSE_CODE_CREDENTIALS_TOPIC
...
object SenseCodeCredentialsManager {
    ...
    private fun createCredentialAttributes(key: String): CredentialAttributes =
        CredentialAttributes(generateServiceName("${SenseCodePlugin.NAME} Attributes", key))
