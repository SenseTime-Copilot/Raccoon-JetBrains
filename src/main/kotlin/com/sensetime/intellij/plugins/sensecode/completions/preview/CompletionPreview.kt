...
class CompletionPreview private constructor(
    ...
    var done: Boolean = false
        set(value) {
            ...
            if (value && currentCompletion.isNullOrEmpty()) {
                SenseCodeNotification.popupNoCompletionSuggestionMessage(
                    editor,
                    SenseCodeSettingsState.instance.isAutoCompleteMode
                )
            }
        }
    ...
    fun showError(message: String) {
        SenseCodeNotification.popupMessageInBestPositionForEditor(
            message,
            editor,
            SenseCodeSettingsState.instance.isAutoCompleteMode
        )
