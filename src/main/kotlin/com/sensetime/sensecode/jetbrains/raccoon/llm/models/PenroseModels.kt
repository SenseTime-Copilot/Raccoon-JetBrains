        ...
        object LanguageService {
            ...
            private val messages: Map<String, Map<String, String>> = mapOf(
                ...
                "zh" to mapOf(
                    ...
                    "completions.task.prompt.penrose.AddTest" to "仔细阅读和理解以下代码内容，理解其功能，然后根据代码功能为为其生成测试代码，确保覆盖所有情况.",
                    "completions.task.prompt.penrose.CodeConversion" to "将以下代码改写为等价的 {0} 代码.",
                    "completions.task.prompt.penrose.CodeCorrection" to "仔细阅读以下代码内容，探查其中可能存在的安全问题，语法问题，逻辑问题等，并给出修正后的代码.",
                    "completions.task.prompt.penrose.Generation" to "仔细阅读以下代码内容，探查其中可能存在的安全问题，语法问题，逻辑问题等，并给出修正后的代码.",
                    "completions.task.prompt.penrose.Refactoring" to "仔细阅读和理解以下代码内容，理解其功能，针对其中的代码易读性问题做改善，例如：变量命名, 代码结构等, 使其结构更加清晰, 更易于阅读和维护",
                ),
                "hant" to mapOf(
